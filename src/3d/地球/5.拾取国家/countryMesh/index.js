...
// 几何体辅助合并工具
import { BufferGeometryUtils } from "../../../libs/three.js-r123/examples/jsm/utils/BufferGeometryUtils.js";
// 引入lon2xyz,经纬度转球面坐标
...
function countryMesh(R, polygonArr) {
  ...
  polygonArr.forEach((obj) => {
    ...
    geometry.index = new THREE.BufferAttribute(
      new Uint16Array(trianglesIndexArr),
      1
    );
    // 设置几何体顶点位置坐标
    geometry.attributes.position = new THREE.BufferAttribute(
      new Float32Array(spherePointsArr),
      3
    );
